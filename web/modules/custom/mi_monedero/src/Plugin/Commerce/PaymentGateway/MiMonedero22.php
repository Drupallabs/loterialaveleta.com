...
namespace Drupal\mi_monedero\Plugin\Commerce\PaymentGateway;
...
/**
 * Provides the Mi Monedero 22 payment gateway.
 *
 * @CommercePaymentGateway(
 *   id = "mi_monedero22",
 *   label = "Mi Monedero 22",
 *   display_label = "Mi Monedero 22",
 *   modes = {
 *     "n/a" = @Translation("N/A"),
 *   },
 *   forms = {
...
class MiMonedero22 extends PaymentGatewayBase implements ManualPaymentGatewayInterface
{
     ...
     */
    protected function doPayment(PaymentInterface $payment)
    {
        ...
        \Drupal::service('mi_monedero.monedero_manager')->updateMonedero($order->getCustomer(), $total);
    }
