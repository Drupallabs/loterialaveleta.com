...
/**
 * Form controller for Monedero edit forms.
 *
 * @ingroup mi_monedero
 */
class MonederoForm extends ContentEntityForm
{
  ...
  public function save(array $form, FormStateInterface $form_state)
  {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addMessage($this->t('Created the %label Monedero.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        $this->messenger()->addMessage($this->t('Saved the %label Monedero.', [
          '%label' => $entity->label(),
        ]));
    }
