...
class PDFController extends ControllerBase
{
    ...
    public function pedidoPdf($pedidoid)
    {
        ...
        $html .= '<p> Realizado con el Usuario:' . $ped->name . '</p>';
        $html .= '<p> Fecha de Pedido:&nbsp;' . date('d/m/Y', $ped->completed) . '</p>';
        $html .= '<table style="border:1px solid black; border-collapse:collapse;">';
        $html .= '<tr><th width="60" style="border: 1px solid black;">Cantidad</th>
                      <th width="200" style="border: 1px solid black;">Articulo</th>
                      <th width="100" style="border: 1px solid black;">Fracci&oacute;n / Serie</th>
                      <th width="80" style="border: 1px solid black;">Precio Unitario</th>
                      <th width="80" style="border: 1px solid black;">Precio</th>
                      </tr>';
        $pedidos = $this->empresasService->damePedido($pedidoid);
        foreach ($pedidos as $record) {
            $html .= '<tr>';
            $html .= '<td style="border: 1px solid black;"><p>' . number_format($record->quantity) . '</p></td>
                      <td style="border: 1px solid black;"><p>' . $record->field_numero_decimo_value . '</p>
                       <small>Décimo del sordeo extraordinario de Navidad de Loteria Nacional, del 22 de diciembre de 2021</small></td>
        ...
        $html .= '<p>Yo <span style="width:100px;">&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; con DNI o NIE: </p>
                  <p></p><p></p><p></p><p></p><p></p>
