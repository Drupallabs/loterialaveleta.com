...
/**
 * Access controller for the sorteo entity.
 *
 * @see \Drupal\sorteo\Entity\Sorteo.
 */
class SorteoAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    return AccessResult::allowedIfHasPermission($account, 'add sorteo entity');
  }
